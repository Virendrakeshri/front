...
import { fetchAllProductsAsync, fetchBrandsAsync, fetchCategoriesAsync, fetchProductsByFiltersAsync, selectbrands, selectcategories} from "../../products-list/productListSlice";
...
import { selectAllProducts } from "../../products-list/productListSlice";
import { handler } from "@tailwindcss/aspect-ratio";
import { fetchCategories } from "../../products-list/productListApi";
const items = [
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {products !== undefined  && products.map((product) => (
            ...
            <div key={product.id} className="group relative">
              ...
              {product.deleted && <div>
               <p className="text-sm text-red-400 my-2">product deleted</p>
              </div>}

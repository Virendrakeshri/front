...
import { clearSelectedProduct, createProductAsync, fetchProductsByIdAsync, updateProductAsync } from '../../products-list/productListSlice';
...
export default function ProductForm(){
   ...
   selectedProduct=useSelector((state)=>state.product.SelectedProduct);
    useEffect(()=>{
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
               <select {...register('brand',{
                ...
                {brands.map((brand)=>(<option value={brand.name}>{brand.value}</option>))};
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
               <select {...register('category',{
                ...
                {categories.map((category)=>(<option value={category.name}>{category.value}</option>))};
